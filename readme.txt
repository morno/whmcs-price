...
* Fix: **Elementor product widget PIDs not cast to integers**: `render_product_pricing()`
...
* Fix: **Lock transients not cleared on manual cache clear**: `clear_whmcs_cache()` in
